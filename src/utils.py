...
default_prefs = {
        ...
        'tile_size': 256,
        'channels': 3,
        'dir': "/home/anas.aitaomar/aihack-water/data/images",
        'headers': {
...
def get_img_by_bbox(tl,br,zoom =17,village_name = ""):
    ...
    # bounding box cordinates +  zoom level 
    # prefs['tl'] = "31.141762466358795, -7.9263350168656075"
    # prefs['br'] = "31.12902260273618, -7.908643158195691"
    prefs["tl"] = tl
    prefs["br"] = br
    prefs['zoom'] = zoom
    ...
    name = f'img_{village_name}_{timestamp}.png'
